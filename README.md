...
**Html means Hypertextmarkup language and it makes the code you write meaningful

2. Name two big differences between ```display: block;``` and ```display: inline;```.

**Display Block allows you to adjust width and the height and the inline space you can't
...
** It's easier to see where changes were made within the multiple iterations and makes for better collaboration
